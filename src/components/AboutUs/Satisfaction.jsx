...
export default function Satisfaction() {
  ...
  return (
    <>
      <div
        className=" bg-gray-100 py-5 bg-no-repeat md:px-20 bg-cover"
                ...
                {cardData.map((card, index) => (
                  <div
                    ...
                    className={`relative mt-6 flex ${
                      index === 2 ? "border-none" : null
                    } md:border-r md:border-b-0 border-b border-opacity-30 border-white  flex-col   bg-clip-border text-white `}
                  >
                    <div className="p-6">
